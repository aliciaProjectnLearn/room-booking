...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 rounded-xl shadow-theme-md p-6">
        ...
        <p class="text-title-md font-bold text-brand-600 dark:text-brand-500 mt-2">{{ $summary['total'] }}</p>
    </div>
    <div class="bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 rounded-xl shadow-theme-md p-6">
        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Disetujui</p>
        <p class="text-title-md font-bold text-success-500 mt-2">{{ $summary['approved'] }}</p>
    </div>
    <div class="bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 rounded-xl shadow-theme-md p-6">
        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Menunggu</p>
        <p class="text-title-md font-bold text-warning-500 mt-2">{{ $summary['pending'] }}</p>
    </div>
    <div class="bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 rounded-xl shadow-theme-md p-6">
        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Ditolak</p>
        <p class="text-title-md font-bold text-red-500 mt-2">{{ $summary['rejected'] }}</p>
    </div>
    <div class="bg-white dark:bg-gray-900 dark:border-gray-800 border border-gray-200 rounded-xl shadow-theme-md p-6">
        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Dibatalkan</p>
        <p class="text-title-md font-bold text-gray-500 mt-2">{{ $summary['cancelled'] }}</p>
    </div>
</div>
